...
export default {
  ...
  params: {
    tA: 6, tB: 9, tC: 14, tD: 18,   // bande T° sol
    warmDays: 14, warmFull: 3,      // vitesse de réchauffement (°C sur 14 j)
    p30Lo: 25, p30Hi: 75,
    ampLo: 8, ampHi: 16,            // amplitude jour/nuit
  },
  ...
  score(s, k, p = this.params) {
    ...
    const raw = band * (0.3 + 0.7 * rising) * (0.4 + 0.6 * moist) * (0.5 + 0.5 * SM) * (0.75 + 0.25 * ampF);
  ...
  criteres: [
    ['Réchauffement du sol', 'T° sol qui monte et franchit 9–14 °C au printemps'],
    ['Réserve hydrique', 'pluie des 30 j (25 → 75 mm) — humidité de sortie d\'hiver'],
    ['Amplitude jour/nuit', 'journées douces, nuits fraîches (> 12–16 °C d\'écart)'],
    ['Gel', 'pénalité si T° min < −2 °C'],
    ['Habitat (à venir)', 'frênaies, ripisylves, et surtout brûlis de l\'année précédente'],
  ],
};
